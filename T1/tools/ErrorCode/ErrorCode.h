...
enum ErrorCode
{
	...
	// 很遗憾护送失败！
	SystemConvoyFailed = 25,
	// 跨服服务器,未开放此功能
	SystemClosedOnCGS = 26,
	/// ====================================================================
	/// 登录系统错误号范围：1001 ~ 1100 
	/// ====================================================================
	//
	...
	// 当前场景不允许使用游乐设施道具
	NotAllowUseRideItemScene = 1017,
	// 没有使用次数了
	RideItemNoTimes = 1018,
	// 游乐设施道具在使用中
	RideItemIsIngUse = 1019,
	// 禁用游乐设施道具
	ForbiddenRideItem = 1020,
	// 该游乐设施道具没有使用
	RideItemNotUse = 1021,
	// 该游乐设施乘坐人员已满
	RideHaveMorePlayer = 1022,
	// 不满足该游乐设施使用条件
	RideCodnDition1 = 1023,
	// 只有所有者可以乘坐
	RideCodnDition2 = 1024,
	// 只有所有者好友与家族成员可以乘坐
	RideCodnDition3 = 1025,
	// 乘坐成功
	RideSuccess = 1026,
	// 收回失败，该游乐设施还有玩家在使用中
	RideHaveInUseRecycleFailed = 1027,
	// 收回成功
	RideHaveRecycleSuccess = 1028,
	// 布置游乐设施成功
	UseRideItemSuccess = 1029,
	// @(Chat)恭喜冒险者[00FF00]%s[-]击杀了[00FF00]%s[-]，获得丰富奖励！
	KillEliteMonsterNotice = 1030,
	/// ====================================================================
	/// 红包系统错误号范围：1101 ~ 2000 
	/// ====================================================================
	//指定目标红包的接收着不是玩家
	...
	// // 与NPC的距离过远
	LifeSkill_FarFromNpc = 2100,
	// // 没有次数了
	LifeSkill_NoCount = 2101,
	// // cd中，请稍后重试
	LifeSkill_CD = 2102,
	// // 所需要的资源数量不足
	LifeSkill_NoItems = 2103,
	// // 没钱了
	LifeSkill_NoMoney = 2104,
	// // 技能没有学习
	LifeSkill_NoLearn = 2105,
	// // 今日已达到最大购买次数
	LifeSkill_CantBuy = 2106,
	// // 技能等级低于资源等级
	LifeSkill_LowLevel = 2107,
	// // 资源类型错误
	LifeSkill_ErrorNpc = 2108,
	// // 精力值不足
	LifeSkill_NoSpirit = 2109,
	// // 购买精力值不能超过上限
	LifeSkill_CantBuyMax = 2110,
	// // 成功购入鱼饵
	LifeSkill_BuyYuErOk = 2111,
	// // 成功购入猎弓
	LifeSkill_BuyLieGong = 2112,
	// // 成功购入锄头
	LifeSkill_BuyChuTou = 2113,
	// // 鱼饵不足
	LifeSkill_NoYuEr = 2114,
	// // 猎弓不足
	LifeSkill_NoLieGong = 2115,
	// // 锄头不足
	LifeSkill_NoChuTou = 2116,
  ...
  MailDeleteAttachment=3312,
	...
	// //发送成功
	ChatErrorMsg_notaic = 4010,
	// //道具数量不足
	ChatErrorMsg_notaicitem = 4011,
	//
	/// ====================================================================
	/// 技能系统错误号范围：5001 ~ 6000
	/// ====================================================================
	...
	// 当前不允许切换地图线路
	ForbidChangeMapLine = 5007,
	// 目标地图线路人数已满，切换失败
	ChangeMapLineFailedCount = 5008,
	// 目标地图线路已销毁，切换失败
	ChangeMapLineFailedDestory = 5009,
	// 切换地图线路失败
	ChangeMapLineFailed = 5010,
	// 查看地图线路失败
	RequestMapLineFailed = 5011,
	// 没有提醒次数了
	NoNoticeNumber = 5012,
	// 提醒成功
	NoticeSuccess = 5013,
  ...
  Friend2AP_Max = 6126,
  // 已经是跨服好友
  Friend2CrossAdd_AlreadyIs = 6127,
  // 短时间内不能重复申请
  Friend2CrossAdd_Wait = 6128,
  // 申请成功，请耐心等待
  Friend2CrossAdd_Success = 6129,
  // 拒绝成功
  Friend2CrossAdd2_Refuse = 6130,
  // 您的跨服好友列表已满
  Friend2CrossAdd2_Max1 = 6131,
  // 对方的跨服好友列表已满
  Friend2CrossAdd2_Max2 = 6132,
  // 同步数据校正
  Friend2CrossAdd2_Fix = 6133,
  ...
  // 照片超过最大尺寸限制
	IdentityPicUp_PicLimitSize = 6217,
	// 已举报过该玩家，请勿重复举报！
	Head_Report_err = 6218,
  ...
  // 骑宠【%s】不可使用
  PetTerritory_CannotUse = 6518,
  
	/// ====================================================================
	/// 乱世为王活动提示：6551 ~ 6600
	/// ====================================================================
	// //@(Tips)不在活动时间内，无法参加活动！
	LSBattleFieldNotRightTime = 6551,
	// //@(Tips)等级不满足活动需求，无法参加活动！
	LSBattleFieldNotEnoughLevel = 6552,
	// //@(Tips)活动地图所有分线满员，请耐心等待...
	LSBattleFieldNotEnoughPlace = 6553,
  
	/// ====================================================================
	/// 体力值系统提示：6601 ~ 6650
	/// ====================================================================
	// //@(Tips)体力值购买次数已达到最大值
	ActionPointNoBuyNumber = 6601,
	// //@(Tips)体力值将要满了，无法购买
	ActionPointFull = 6602,
	// //@(Tips)体力值不足
	ActionPointNotEnough = 6603,
	//@(Chat | Tips)体力值不足，无法获得结算奖励
	ActionPointNotEnoughByCopyMapEnd = 6604,

	/// ====================================================================
	/// 跨服活动通用报名匹配：6651 ~ 6700
	/// ====================================================================
	// 您需要前往%s进行报名
	CrossActivity_Apply_InvalidMap=6651,
	// 不能在位面中报名
	CrossActivity_Apply_FromGroup=6652,
	// 您的同伴等级太低无法报名
	CrossActivity_Apply_PartnerLevelTooLow=6653,
	// 活动尚未开启
	CrossActivity_Apply_NotOpen=6654,
	// 不在报名时间
	CrossActivity_Apply_NotTime=6655,
	// 队伍人数太多，无法报名
	CrossActivity_Apply_RoleTooMuch=6656,
	// 队伍人数太少，无法报名
	CrossActivity_Apply_RoleTooLittle=6657,
	// 队伍内最大战力差（不含骑宠）超过限制，无法报名
	CrossActivity_Apply_ForceNoPet=6658,
	// 队伍内最大战力差（包含骑宠）超过限制，无法报名
	CrossActivity_Apply_Force=6659,
	// 活动人数已满，请下次参与，或者等等看有没有人退票？
	CrossActivity_Apply_Max=6660,
	// 需要在骑乘状态进行报名
	CrossActivity_Apply_NeedPet=6661,
	// 乘客无法报名，请让司机去报名
	CrossActivity_Apply_NeedMaster=6662,
	// 队员无法报名，请让队长去报名
	CrossActivity_Apply_NeedLeader=6663,
	// 您的同伴需要前往%s与您一起报名
	CrossActivity_Apply_PartnerInvalidMap=6664,
	// 您的进入次数不足，无法报名
	CrossActivity_Apply_NeedCount=6665,
	// 您的同伴进入次数不足，无法报名
	CrossActivity_Apply_PartnerNeedCount=6666,
	// 请您退出队伍再进行报名
	CrossActivity_Apply_NeedAlone=6667,

	/// ====================================================================
	/// 怪物图鉴：6701 ~ 6750
	/// ====================================================================
  // 重复拍照，忽略请求
  MonsterBook_AlreadySnap = 6701,
  // 没有达到解锁条件
  MonsterBook_Locked = 6702,
  // 没有达到领奖条件
  MonsterBook_NoReward = 6703,
  // 已经解锁了
  MonsterBook_UnLocked = 6704,
  // 已经领过了
  MonsterBook_Rewarded = 6705,
  // 您已解锁%s的怪物图鉴信息！
  MonsterBook_NewMap = 6706,

	/// ====================================================================
	/// 跨服活动-大逃杀：6751 ~ 6800
	/// ====================================================================
  // 获得了【%s】
  CrossActivity_Alive_GetEquip = 6751,
  // 吃到了【%s】
  CrossActivity_Alive_GetItem = 6752,
  // 你没有装备武器，不能报名
  CrossActivity_Alive_Noweapon = 6753,
  // 你取下了武器，匹配被终止！
  CrossActivity_Alive_Offweapon = 6754,
  ...
  // 已经领取过该祈福进度奖励
  GuildGodBlessScheduleAlreadyGet = 7159,
  // 只有族长才能设置快速加入的条件
  GuildFastJoinSetPowerless = 7160,
  // 已经加入家族
  GuildFastJoinAlreadyJoin = 7161,
  // 暂无符合条件的家族
  GuildFastJoinNotFind = 7162,
  // 邀请已超时
  GuildRecruitTimeOut = 7163,
  // 家族成员已满，无法邀请
  GuildRecruitMemberMax = 7164,
  // 发布招募CD中，请等待%u秒
  GuildOneKeyRecruitCD = 7165,
  // 成功提交%u个%s，雪人进度增加！
  GuildSnowmanDonate = 7166,
  // 您申请的家族已经超过%u个，已为您保留最近的%u个申请！
  GuildApplyMax = 7167,
  // 您今天已经发布过祈愿了
  GuildSupp_AlreadyHave = 7168,
  // 无法通过祈愿获得该物品
  GuildSupp_InvalidItem = 7169,
  // 只能向同家族成员赠送碎片
  GuildSupp_InvalidTar = 7170,
  // 对方今日收到的碎片已经足够多了
  GuildSupp_Enough = 7171,
  // 您今天已经给这位成员赠送过碎片了
  GuildSupp_AlreadyGive = 7172,
  // 对方不接受您的赠礼（对方的祈愿无效）
  GuildSupp_Refuse = 7173,
  // 获得 %u 积分
  GuildButtle_Point = 7174,
	// 当前任务不可索取
	GuildLoopTask_InvalidTask = 7175,
	// 当前任务已经索取
	GuildLoopTask_AlreadyWantGet = 7176,
	// 您的物品足够，不需要索取
	GuildLoopTask_NoNeed = 7177,
	// 当日索取次数已达上限
	GuildLoopTask_MaxWantGet = 7178,
	// 不能捐赠给自己
	GuildLoopTask_CannotGiveSelf = 7179,
	// 对方和您不在同一家族
	GuildLoopTask_NotSameGuild = 7180,
	// 该条索取已失效
	GuildLoopTask_InvalidWantGet = 7181,
	// 已经捐赠过了
	GuildLoopTask_AlreadyGive = 7182,
	// 成功发起索取
	GuildLoopTask_WantGetS = 7183,
	// 捐赠成功
	GuildLoopTask_GiveS = 7184,
	// 捐献失败，数量超过索取上限，请重新选择。
	GuildLoopTask_GiveF_GoodsMore = 7185,
	// 已开启快速招募
	Guild_recruit_on = 7186,
	// 已关闭快速招募
	Guild_recruit_off = 7187,
  
  /// ====================================================================
	/// 组队系统错误号范围：7500 ~ 8000
	/// ====================================================================
	// 你选择的副本次数不足或体力不足
	TeamAllSelectedCopyMapCantIn = 7500,
	// 在副本中不能匹配队伍
	TeamCantMatchInCopyMap = 7501,
	// 已经有队伍
	TeamHasTeam = 7502,
	// 只有队长才能操作
	TeamOnlyLeaderCanOp = 7503,
	// 对方已有队伍
	TeamTargetHasTeam = 7504,
	// 队伍人数已满
	TeamMemberMax = 7505,
	// 队伍已经快速开始副本
	TeamAreadyStartCopy = 7506,
	// 队伍已解散
	TeamDissmissed = 7507,
	// 不能对自己操作
	TeamCantBeSelf = 7508,
	// 目标不在队伍中
	TeamTargetNotInTeam = 7509,
	// 请选择一个副本
	TeamCantChangeMapZero = 7510,
	// 您没有队伍
	TeamSelftNotInTeam = 7511,
	//[%s]不能进入副本 
	TeamSomeOneCantInCopyMap = 7512,
	// 请选择一个队友转移队长
	TeamChangeLeaderTargetNotInTeam = 7513,
	// 快速开始副本已经取消
	TeamStartCopyMapCancel = 7514,
	// 您已经确认
	TeamAckStartCopyMapOk = 7515,
	// 系统将自动为你匹配队伍
	TeamSystemMatchTeamForU = 7516,
	// 副本中不能操作
	TeamCantOpInCopyMap = 7517,
	// [%s]加入队伍！
	TeamSomeOneJoin = 7518,
	// 队伍喊话成功发出
	TeamQuickInfoSendOk = 7519,
	// 成功向[%s]发出组队邀请！
	TeamInviteSomeOnOk = 7520,
	// 您被踢出队伍
	TeamLeaderKickU = 7521,
	// 有队员离线，不能开始副本
	TeamSomeoneOffline = 7522,
	// 当前队伍人数超过副本人数[%s]人，将无法进入副本
	TeamMemberTooMuchForMap = 7523,
	// 队伍已经被锁定
	TeamCantJoinBeLocked = 7524,
	// 当前地图不允许加入队伍
	TeamCantJoinInSpecialMap = 7525,
	...
	// //碎片背包整理完毕
	BagSortPiecesBagComplete = 8071,
	// //碎片仓库整理完毕
	BagSortPiecesStorageComplete = 8072,
	// //装备孔位未镶嵌纹章
	EquipSlotInvalidGem = 8073,
	// //装备孔位错误
	EquipSlotInvalid = 8074,
	// //升级纹章所需材料不足
	EquipSlotCostNotEnough = 8075,
	// //纹章不存在
	EquipGemNotInvalid = 8076,
	// 时装激活条件不满足
	FashionActiveCondition = 8077,
	// 时装消耗不足
	FashionConsumeNotEnough = 8078,
	// emmmm....精炼失败了呢
	EquipRefineFailedAddOdd = 8079,
	// 当前装备需要先进行突破
	EquipStarFailedIsUP = 8080,
	// 亲爱的玩家,您的生活背包已满！将无法获得道具！请及时清理
	BagItem_LifeFull = 8081,
	// //材料背包整理完毕
	BagSortLifeBagComplete = 8082,
	// //材料仓库整理完毕
	BagSortLifeStorageComplete = 8083,
	// //已成功扩展道具背包 
	BagOpenSlotByItemSuc = 8084,
	// //已成功扩展装备背包 
	EquipBagOpenSlotByItemSuc = 8085,
	// //已成功扩展碎片背包 
	PiecesBagOpenSlotByItemSuc = 8086,
	// //已成功扩展材料背包 
	LifeBagOpenSlotByItemSuc = 8087,
	// //已成功扩展所有背包 
	AllBagOpenSlotByItemSuc = 8088,
	// //道具背包空间已全部解锁
	BagOpenSlotByItemFailed = 8089,
	// //装备背包空间已全部解锁
	EquipBagOpenSlotByItemFailed = 8090,
	// //碎片背包空间已全部解锁
	PiecesBagOpenSlotByItemFailed = 8091,
	// //材料背包空间已全部解锁
	LifeBagOpenSlotByItemFailed = 8092,
	// //所有背包空间已全部解锁
	AllBagOpenSlotByItemFailed = 8093,
	...
	// 宠物技能不存在
	PetSkillNotExists = 9066,
	// 宠物技能升级条件不满足
	PetSkillConditionErr = 9067,
	// 宠物技能升级消耗不足
	PetSkillCostNotEnough = 9068,
	// 已经达到最大技能等级
	PetSkillMaxLevel = 9069,
	// 狂怒值高于%u时不可召唤宠物助战
	PetCantShowPKValue = 9070,
	// 宠物技能等级不能超过宠物等级
	PetSkillCantSelfLevel = 9071,
	...
	// 副本不能购买进入次数
	CopyMap_Can_Not_Buy_Count = 10108,
	// 副本今日购买次数超上限
	CopyMap_Buy_Max = 10109,
	// 副本购买次数花费钻石数量配置错误
	CopyMap_Cfg_Error = 10110,
	// 货币不足
	Activety_Coin_Not_Enough = 10111,
	// 鼓舞值已经达到上限 
	World_Boss_Inspire_Value_Max = 10112,
	// 该类型鼓舞次数达到上限
	World_Boss_Inspire_Type_Max = 10113,
	/// ====================================================================
	...
	// 等级达到%u级才能接取家族公会任务！
	TaskFailed_LoopTaskAccept_RoleLevel = 13017,
	// 当前无可接取次数
	TaskFailed_LoopTaskAccept_Count = 13018,
	// 免费刷新次数不足
	TaskFailed_LoopTaskAccept_RefreshFreeCount = 13019,
	// 付费刷新次数不足
	TaskFailed_LoopTaskAccept_RefreshCostCount = 13020,
	// 付费刷新时货币不足
	TaskFailed_LoopTaskAccept_RefreshCostCoin = 13021,
	// 单次五星时货币不足
	TaskFailed_LoopTaskAccept_FiveStarCoin = 13022,
	// 所需道具不足
	TaskFailed_NeedItem = 13023,
	// 一键五星时货币不足
	TaskFailed_LoopTaskAccept_AllFiveStarCoin = 13024,
	// 全部五星使用成功，本环剩余任务将全部以五星接取
	TaskSuccess_LoopTaskAccept_AllFiveStar = 13025,
	// 
	/// ====================================================================
	/// 玩家设置系统错误
	/// ====================================================================
  ...
  SevenDayAimClose = 21501,
  // 活动时间已经结束，感谢您的参与
  SevenDayAimTimeOut = 21502,
  // 该目标不是当天目标，请下次参与
  SevenDayAimDayError = 21503,
  // 没有达到条件，无法领取奖励
  SevenDayAimCannot = 21504,
  // 已领取该奖励了，请勿重复领取
  SevenDayAimAlreadyReward = 21505,
	/// ====================================================================
	/// 30日登录送大礼错误号范围：21551 ~ 22000 
	/// ====================================================================
  // 活动时间已经结束，感谢您的参与
  ThirtyDayLoginGiftTimeOut = 21551,
  // 没有达到条件，无法领取奖励
  ThirtyDayLoginGiftCannot = 21552,
  // 请主人先领取上一个奖励！
  ThirtyDayLoginGiftNeedPrevious = 21553,
  // 已领取该奖励了，请勿重复领取
  ThirtyDayLoginGiftAlreadyReward = 21554,
	...
	/// ====================================================================
	// 只有组队才能进入副本
	NeedTeamEnterCopyMap = 23001,
	// 您当前不属于这个副本，进入失败
	PlayerNotBelongCopyMap = 23002,
	// 今日手动刷新次数已消耗完
	PlayerMSShopNoFreshTimes = 23003,
	// 赠送成功
	MallBuy_Send_Iteam = 23004,
	// 目标地图正在销毁流程中了，请稍候再试！
	TargetCopyMapIsInDestroy = 23005,
	// 等级不足%u级，报名失败
	ApplyDanceFailedPlayerLevel = 23006,
	// 活动尚未开始
	DanceActivityNotStart = 23007,
	// 报名成功
	ApplyDanceSuccess = 23008,
	// 已经报名，不可重复报名
	AlreadyApplyDance = 23009,
	// 没有报名参加活动
	NotApplyDanceInArea = 23010,
	// 进入广场，开始跳舞吧。
	InDanceArea = 23011,
	// 离开跳舞活动，将不能获得经验
	OutDanceArea = 23012,
	// 不在跳舞阶段
	NotInDancePhase = 23013,
	// 不在跳舞区域
	NotInDanceArea = 23014,
	// 已经开启助战
	AlreadyOpenAssist = 23015,
	// 已经取消助战
	AlreadyCancelAssist = 23016,
	// 开启助战成功
	OpenAssistSuccess = 23017,
	// 取消助战成功
	CancelAssistSuccess = 23018,
	// 当前地图不允许使用变形药水
	CurMapNotAllowTransformation = 23019,
	// @(Chat | Tips)你的变形效果被清除
	DeleteTransformationState = 23020,
	// 当前没有可收取附件！
	MailGetItemAllFailed = 23021,
	// 背包已满，请清理背包！
	MailGetItemAllFailedBePackageMore = 23022,
	// 家园不存在
	HomeNotExist = 23023,
	// 目标还没有家园
	TargetHavaNotHome = 23024,
	// 创建家园失败
	CreateHomeFailed = 23025,
	// 不满足开垦条件
	NotMatchOpenCondition = 23026,
	// 不满足升级条件
	NotMatchUpgradeCondition = 23027,
	// 出现系统错误，开垦失败
	SystemErrorOpenFailed = 23028,
	// 开垦成功
	HomeOpenSuccess = 23029,
	// 升级成功
	HomeUpgradeSuccess = 23030,
	// 出现系统错误，升级失败
	SystemErrorUpgradeFailed = 23031,
	// 家园名不合法
	HomeNameNotUse = 23032,
	// 当前处于安全区，不会受到攻击
	InPeaceSafeMode = 23033,
	// 当前处于非安全区，可能会受到攻击，请小心
	NotInPeaceSafeMode = 23034,
	// 目标区域尚未开放
	HomePlant_NotOpen = 23035,
	// 访客无操作权限
	HomePlant_Guest = 23036,
	// 已经种植，无法再次种植
	HomePlant_AlreadyPlant = 23037,
	// 没呀没钱买种子
	HomePlant_PlantWithoutMoney = 23038,
	// 目标无效，无法操作
	HomePlant_TarNull = 23039,
	// 目标已经枯萎，无法操作
	HomePlant_TarDie = 23040,
	// 怎么也找不到虫子
	HomePlant_PestisNull = 23041,
	// 没有成熟，没有收获
	HomePlant_HarvestNot = 23042,
	// 今天已经浇了太多水，再浇就淹死了
	HomePlant_WartringMore = 23043,
	// 浇水不能太频繁，请等作物歇口气
	HomePlant_WartringCD = 23044,
	// 今天已经施肥太多，小心土地盐碱化
	HomePlant_CompostMore = 23045,
	// 施肥不能太频繁，请等作物歇口气
	HomePlant_CompostCD = 23046,
	// 背包中没有对应的肥料
	HomePlant_CompostWithoutItem = 23047,
	// %s成长值获得了小幅提升
	HomePlant_CompostLittle = 23048,
	// %s成长值获得了大幅提升
	HomePlant_CompostBig = 23049,
	// 也没有钱买肥料
	HomePlant_CompostWithoutMoney = 23050,
	//该家园正在装修中，不可拜访
	Home_isBuilding = 23051,
	//友好度不足，不能进入别人的家园
	Home_FriendnessLack = 23052,
	//家园等级不足，无法种植该作物
	HomePlant_LevelRequire = 23053,
	//今天已经偷了很多菜了，给别人留一点吧。
	HomePlant_StealLimit = 23054,
	//偷了一个烂植物，什么都没有得到。
	HomePlant_StealisZero = 23055,
	/// ====================================================================
	...
	// 不在家族游乐场中
	GuildFairground_NeedIn = 28435,
	// 使用设施时，目标设施无效
	GuildFairground_ErrorRideID = 28436,
	// 家族资金不足，设施正在维护中
	GuildFairground_Maintain = 28437,
	// 设施未到开放时间
	GuildFairground_Close = 28438,
	// 乘坐操作时，正在乘坐任意设施
	GuildFairground_Riding = 28439,
	// 乘坐操作时，目标设施已满员
	GuildFairground_Full = 28440,
	// 贡献度不足，无法乘坐
	GuildFairground_CoinLess = 28441,
	// 升级操作时，设施等级已达到家族等级
	GuildFairground_LevelLimit = 28442,
	// 升级操作时，设施等级已达到最大等级
	GuildFairground_LevelMax = 28443,
	// 升级操作时，设施等级已达到配置限制
	GuildFairground_LevelLimit2 = 28444,
	// 设施未开放
	GuildFairground_NotOpen = 28445,
	// 只有大长老及以上职位可操作
	GuildFairground_GuildBoss_1 = 28446,
	/// ====================================================================
	/// 跨服混沌战场：28501 ~ 28600
	//	当前跨服战场线路已满
  ...
  Marriage_CD = 29127,  
	// 协议离婚失败，需要在同一地图
	Marriage_BreakNeedMap = 29128,
	// 对方尚未开启【婚姻】功能
	Marriage_NotOpen = 29129,	
	// 结婚之后才可以进行【情缘任务】哟~
	Marriage_Single = 29130,
	// 结婚之后才可以直接使用婚戒增加亲密度哟~
	Marriage_UseMarriageRing = 29131,
	...
	/// 集字活动
	// 集字材料不足!
	CollectionWordsNotEnough = 30105,
	// 兑换次数达到上限!
	CollectionWordsCountLimit = 30106,
	// 活动还未开启!
	CollectionWordsNotInTime = 30107,
