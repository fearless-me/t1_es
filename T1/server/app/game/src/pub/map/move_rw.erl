...
get_move_speed_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.move_speed 
	end.

set_move_speed(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{move_speed = V}),
...
get_cur_move_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.cur_move 
	end.

set_cur_move(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{cur_move = V}),
...
get_next_move_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.next_move 
	end.

set_next_move(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{next_move = V}),
...
get_vis_tile_idx_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.vis_tile_idx 
	end.

set_vis_tile_idx(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{vis_tile_idx = V}),
...
get_cur_pos_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.cur_pos 
	end.

set_cur_pos(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{cur_pos = V}),
...
get_start_pos_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.start_pos 
	end.

set_start_pos(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{start_pos = V}),
...
get_dest_pos_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.dest_pos 
	end.

set_dest_pos(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{dest_pos = V}),
...
get_face_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.face 
	end.

set_face(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{face = V}),
...
get_dir_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.dir 
	end.

set_dir(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{dir = V}),
...
get_start_time_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.start_time 
	end.

set_start_time(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{start_time = V}),
...
get_seg_move_time_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.seg_move_time 
	end.

set_seg_move_time(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{seg_move_time = V}),
...
get_force_stopped_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.force_stopped 
	end.

set_force_stopped(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{force_stopped = V}),
...
get_path_list_def(Uid,Def)->
	case erlang:get({Uid,m_map_unit_move_rw}) of
	undefined -> Def; 
	V -> V#m_map_unit_move_rw.path_list 
	end.

set_path_list(Uid,V)->
	R = erlang:get({Uid,m_map_unit_move_rw}),
	erlang:put({Uid,m_map_unit_move_rw}, R#m_map_unit_move_rw{path_list = V}),
...
%%-------------------------------------------------------------------
del(Uid)-> erlang:erase({Uid,m_map_unit_move_rw}).

%%-------------------------------------------------------------------
to_record(Uid)-> erlang:get({Uid,m_map_unit_move_rw}).

%%-------------------------------------------------------------------
set(Uid,#m_map_unit_move_rw{}=V)->
	erlang:put({Uid,m_map_unit_move_rw}, V).

%%-------------------------------------------------------------------
init_default(Uid)-> erlang:put({Uid,m_map_unit_move_rw}, #m_map_unit_move_rw{}).
init_default(Uid,#m_map_unit_move_rw{}=V) -> erlang:put({Uid,m_map_unit_move_rw}, V).

%%-------------------------------------------------------------------
set_fields(_Uid,[]) ->ok;
set_fields(Uid,FieldList) ->
	R1 = erlang:get({Uid,m_map_unit_move_rw}),
	R2 = i_set_fields(Uid,FieldList,R1),
	erlang:put({Uid,m_map_unit_move_rw}, R2),
	ok.
...
i_set_field(Uid,{move_speed, Val}, R) ->
	R1 = R#m_map_unit_move_rw{move_speed = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,move_speed,R)),
	R1;
i_set_field(Uid,{move_speed, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{move_speed = R#m_map_unit_move_rw.move_speed + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,move_speed,R)),
	R1;
i_set_field(Uid,{move_speed, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,move_speed,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.move_speed, Val}, R) ->
	R1 = R#m_map_unit_move_rw{move_speed = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,move_speed,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.move_speed, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{move_speed = R#m_map_unit_move_rw.move_speed + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,move_speed,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.move_speed, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{move_speed = R#m_map_unit_move_rw.move_speed - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,move_speed,R)),
	R1;
%%#m_map_unit_move_rw.cur_move
i_set_field(Uid,{cur_move, Val}, R) ->
	R1 = R#m_map_unit_move_rw{cur_move = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,cur_move,R)),
	R1;
i_set_field(Uid,{cur_move, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{cur_move = R#m_map_unit_move_rw.cur_move + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,cur_move,R)),
	R1;
i_set_field(Uid,{cur_move, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,cur_move,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.cur_move, Val}, R) ->
	R1 = R#m_map_unit_move_rw{cur_move = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,cur_move,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.cur_move, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{cur_move = R#m_map_unit_move_rw.cur_move + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,cur_move,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.cur_move, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{cur_move = R#m_map_unit_move_rw.cur_move - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,cur_move,R)),
	R1;
%%#m_map_unit_move_rw.next_move
i_set_field(Uid,{next_move, Val}, R) ->
	R1 = R#m_map_unit_move_rw{next_move = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,next_move,R)),
	R1;
i_set_field(Uid,{next_move, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{next_move = R#m_map_unit_move_rw.next_move + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,next_move,R)),
	R1;
i_set_field(Uid,{next_move, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,next_move,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.next_move, Val}, R) ->
	R1 = R#m_map_unit_move_rw{next_move = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,next_move,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.next_move, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{next_move = R#m_map_unit_move_rw.next_move + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,next_move,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.next_move, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{next_move = R#m_map_unit_move_rw.next_move - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,next_move,R)),
	R1;
%%#m_map_unit_move_rw.vis_tile_idx
i_set_field(Uid,{vis_tile_idx, Val}, R) ->
	R1 = R#m_map_unit_move_rw{vis_tile_idx = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,vis_tile_idx,R)),
	R1;
i_set_field(Uid,{vis_tile_idx, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{vis_tile_idx = R#m_map_unit_move_rw.vis_tile_idx + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,vis_tile_idx,R)),
	R1;
i_set_field(Uid,{vis_tile_idx, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,vis_tile_idx,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.vis_tile_idx, Val}, R) ->
	R1 = R#m_map_unit_move_rw{vis_tile_idx = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,vis_tile_idx,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.vis_tile_idx, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{vis_tile_idx = R#m_map_unit_move_rw.vis_tile_idx + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,vis_tile_idx,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.vis_tile_idx, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{vis_tile_idx = R#m_map_unit_move_rw.vis_tile_idx - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,vis_tile_idx,R)),
	R1;
%%#m_map_unit_move_rw.cur_pos
i_set_field(Uid,{cur_pos, Val}, R) ->
	R1 = R#m_map_unit_move_rw{cur_pos = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,cur_pos,R)),
	R1;
i_set_field(Uid,{cur_pos, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{cur_pos = R#m_map_unit_move_rw.cur_pos + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,cur_pos,R)),
	R1;
i_set_field(Uid,{cur_pos, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,cur_pos,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.cur_pos, Val}, R) ->
	R1 = R#m_map_unit_move_rw{cur_pos = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,cur_pos,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.cur_pos, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{cur_pos = R#m_map_unit_move_rw.cur_pos + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,cur_pos,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.cur_pos, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{cur_pos = R#m_map_unit_move_rw.cur_pos - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,cur_pos,R)),
	R1;
%%#m_map_unit_move_rw.start_pos
i_set_field(Uid,{start_pos, Val}, R) ->
	R1 = R#m_map_unit_move_rw{start_pos = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,start_pos,R)),
	R1;
i_set_field(Uid,{start_pos, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{start_pos = R#m_map_unit_move_rw.start_pos + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,start_pos,R)),
	R1;
i_set_field(Uid,{start_pos, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,start_pos,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.start_pos, Val}, R) ->
	R1 = R#m_map_unit_move_rw{start_pos = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,start_pos,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.start_pos, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{start_pos = R#m_map_unit_move_rw.start_pos + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,start_pos,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.start_pos, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{start_pos = R#m_map_unit_move_rw.start_pos - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,start_pos,R)),
	R1;
%%#m_map_unit_move_rw.dest_pos
i_set_field(Uid,{dest_pos, Val}, R) ->
	R1 = R#m_map_unit_move_rw{dest_pos = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,dest_pos,R)),
	R1;
i_set_field(Uid,{dest_pos, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{dest_pos = R#m_map_unit_move_rw.dest_pos + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,dest_pos,R)),
	R1;
i_set_field(Uid,{dest_pos, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,dest_pos,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.dest_pos, Val}, R) ->
	R1 = R#m_map_unit_move_rw{dest_pos = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,dest_pos,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.dest_pos, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{dest_pos = R#m_map_unit_move_rw.dest_pos + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,dest_pos,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.dest_pos, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{dest_pos = R#m_map_unit_move_rw.dest_pos - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,dest_pos,R)),
	R1;
%%#m_map_unit_move_rw.face
i_set_field(Uid,{face, Val}, R) ->
	R1 = R#m_map_unit_move_rw{face = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,face,R)),
	R1;
i_set_field(Uid,{face, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{face = R#m_map_unit_move_rw.face + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,face,R)),
	R1;
i_set_field(Uid,{face, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,face,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.face, Val}, R) ->
	R1 = R#m_map_unit_move_rw{face = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,face,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.face, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{face = R#m_map_unit_move_rw.face + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,face,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.face, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{face = R#m_map_unit_move_rw.face - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,face,R)),
	R1;
%%#m_map_unit_move_rw.dir
i_set_field(Uid,{dir, Val}, R) ->
	R1 = R#m_map_unit_move_rw{dir = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,dir,R)),
	R1;
i_set_field(Uid,{dir, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{dir = R#m_map_unit_move_rw.dir + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,dir,R)),
	R1;
i_set_field(Uid,{dir, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,dir,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.dir, Val}, R) ->
	R1 = R#m_map_unit_move_rw{dir = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,dir,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.dir, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{dir = R#m_map_unit_move_rw.dir + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,dir,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.dir, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{dir = R#m_map_unit_move_rw.dir - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,dir,R)),
	R1;
%%#m_map_unit_move_rw.start_time
i_set_field(Uid,{start_time, Val}, R) ->
	R1 = R#m_map_unit_move_rw{start_time = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,start_time,R)),
	R1;
i_set_field(Uid,{start_time, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{start_time = R#m_map_unit_move_rw.start_time + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,start_time,R)),
	R1;
i_set_field(Uid,{start_time, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,start_time,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.start_time, Val}, R) ->
	R1 = R#m_map_unit_move_rw{start_time = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,start_time,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.start_time, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{start_time = R#m_map_unit_move_rw.start_time + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,start_time,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.start_time, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{start_time = R#m_map_unit_move_rw.start_time - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,start_time,R)),
	R1;
%%#m_map_unit_move_rw.seg_move_time
i_set_field(Uid,{seg_move_time, Val}, R) ->
	R1 = R#m_map_unit_move_rw{seg_move_time = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,seg_move_time,R)),
	R1;
i_set_field(Uid,{seg_move_time, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{seg_move_time = R#m_map_unit_move_rw.seg_move_time + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,seg_move_time,R)),
	R1;
i_set_field(Uid,{seg_move_time, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,seg_move_time,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.seg_move_time, Val}, R) ->
	R1 = R#m_map_unit_move_rw{seg_move_time = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,seg_move_time,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.seg_move_time, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{seg_move_time = R#m_map_unit_move_rw.seg_move_time + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,seg_move_time,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.seg_move_time, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{seg_move_time = R#m_map_unit_move_rw.seg_move_time - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,seg_move_time,R)),
	R1;
%%#m_map_unit_move_rw.force_stopped
i_set_field(Uid,{force_stopped, Val}, R) ->
	R1 = R#m_map_unit_move_rw{force_stopped = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,force_stopped,R)),
	R1;
i_set_field(Uid,{force_stopped, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{force_stopped = R#m_map_unit_move_rw.force_stopped + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,force_stopped,R)),
	R1;
i_set_field(Uid,{force_stopped, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,force_stopped,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.force_stopped, Val}, R) ->
	R1 = R#m_map_unit_move_rw{force_stopped = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,force_stopped,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.force_stopped, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{force_stopped = R#m_map_unit_move_rw.force_stopped + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,force_stopped,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.force_stopped, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{force_stopped = R#m_map_unit_move_rw.force_stopped - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,force_stopped,R)),
	R1;
%%#m_map_unit_move_rw.path_list
i_set_field(Uid,{path_list, Val}, R) ->
	R1 = R#m_map_unit_move_rw{path_list = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,path_list,R)),
	R1;
i_set_field(Uid,{path_list, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{path_list = R#m_map_unit_move_rw.path_list + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,path_list,R)),
	R1;
i_set_field(Uid,{path_list, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,path_list,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.path_list, Val}, R) ->
	R1 = R#m_map_unit_move_rw{path_list = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,path_list,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.path_list, Val, add}, R) ->
	R1 = R#m_map_unit_move_rw{path_list = R#m_map_unit_move_rw.path_list + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,path_list,R)),
	R1;
i_set_field(Uid,{#m_map_unit_move_rw.path_list, Val, sub}, R) ->
	R1 = R#m_map_unit_move_rw{path_list = R#m_map_unit_move_rw.path_list - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,path_list,R)),
	R1;
