...
-export([
	...
	get_hp/1,get_hp_def/2,set_hp/2,set_hp_direct/2, % #m_unit_rw.hp
	get_max_hp/1,get_max_hp_def/2,set_max_hp/2,set_max_hp_direct/2, % #m_unit_rw.max_hp
	get_attr/1,get_attr_def/2,set_attr/2,set_attr_direct/2, % #m_unit_rw.attr
	get_buff_list/1,get_buff_list_def/2,set_buff_list/2,set_buff_list_direct/2, % #m_unit_rw.buff_list
	get_skill_queue/1,get_skill_queue_def/2,set_skill_queue/2,set_skill_queue_direct/2, % #m_unit_rw.skill_queue
	% common function 
...
set_hp(Uid,V)->
	R = erlang:get({Uid,m_unit_rw}),
	erlang:put({Uid,m_unit_rw}, R#m_unit_rw{hp = V}),
...
get_max_hp_def(Uid,Def)->
	case erlang:get({Uid,m_unit_rw}) of
	undefined -> Def; 
	V -> V#m_unit_rw.max_hp 
	end.

set_max_hp(Uid,V)->
	R = erlang:get({Uid,m_unit_rw}),
	erlang:put({Uid,m_unit_rw}, R#m_unit_rw{max_hp = V}),
...
set_attr(Uid,V)->
	R = erlang:get({Uid,m_unit_rw}),
	erlang:put({Uid,m_unit_rw}, R#m_unit_rw{attr = V}),
...
get_buff_list_def(Uid,Def)->
	case erlang:get({Uid,m_unit_rw}) of
	undefined -> Def; 
	V -> V#m_unit_rw.buff_list 
	end.

set_buff_list(Uid,V)->
	R = erlang:get({Uid,m_unit_rw}),
	erlang:put({Uid,m_unit_rw}, R#m_unit_rw{buff_list = V}),
...
i_set_field(Uid,{hp, Val}, R) ->
	R1 = R#m_unit_rw{hp = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,hp,R)),
	R1;
i_set_field(Uid,{hp, Val, add}, R) ->
	R1 = R#m_unit_rw{hp = R#m_unit_rw.hp + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,hp,R)),
	R1;
i_set_field(Uid,{hp, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,hp,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.hp, Val}, R) ->
	R1 = R#m_unit_rw{hp = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,hp,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.hp, Val, add}, R) ->
	R1 = R#m_unit_rw{hp = R#m_unit_rw.hp + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,hp,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.hp, Val, sub}, R) ->
	R1 = R#m_unit_rw{hp = R#m_unit_rw.hp - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,hp,R)),
	R1;
%%#m_unit_rw.max_hp
i_set_field(Uid,{max_hp, Val}, R) ->
	R1 = R#m_unit_rw{max_hp = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,max_hp,R)),
	R1;
i_set_field(Uid,{max_hp, Val, add}, R) ->
	R1 = R#m_unit_rw{max_hp = R#m_unit_rw.max_hp + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,max_hp,R)),
	R1;
i_set_field(Uid,{max_hp, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,max_hp,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.max_hp, Val}, R) ->
	R1 = R#m_unit_rw{max_hp = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,max_hp,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.max_hp, Val, add}, R) ->
	R1 = R#m_unit_rw{max_hp = R#m_unit_rw.max_hp + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,max_hp,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.max_hp, Val, sub}, R) ->
	R1 = R#m_unit_rw{max_hp = R#m_unit_rw.max_hp - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,max_hp,R)),
	R1;
%%#m_unit_rw.attr
i_set_field(Uid,{attr, Val}, R) ->
	R1 = R#m_unit_rw{attr = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,attr,R)),
	R1;
i_set_field(Uid,{attr, Val, add}, R) ->
	R1 = R#m_unit_rw{attr = R#m_unit_rw.attr + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,attr,R)),
	R1;
i_set_field(Uid,{attr, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,attr,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.attr, Val}, R) ->
	R1 = R#m_unit_rw{attr = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,attr,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.attr, Val, add}, R) ->
	R1 = R#m_unit_rw{attr = R#m_unit_rw.attr + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,attr,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.attr, Val, sub}, R) ->
	R1 = R#m_unit_rw{attr = R#m_unit_rw.attr - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,attr,R)),
	R1;
%%#m_unit_rw.buff_list
i_set_field(Uid,{buff_list, Val}, R) ->
	R1 = R#m_unit_rw{buff_list = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,buff_list,R)),
	R1;
i_set_field(Uid,{buff_list, Val, add}, R) ->
	R1 = R#m_unit_rw{buff_list = R#m_unit_rw.buff_list + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,buff_list,R)),
	R1;
i_set_field(Uid,{buff_list, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,buff_list,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.buff_list, Val}, R) ->
	R1 = R#m_unit_rw{buff_list = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,buff_list,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.buff_list, Val, add}, R) ->
	R1 = R#m_unit_rw{buff_list = R#m_unit_rw.buff_list + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,buff_list,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.buff_list, Val, sub}, R) ->
	R1 = R#m_unit_rw{buff_list = R#m_unit_rw.buff_list - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,buff_list,R)),
	R1;
%%#m_unit_rw.skill_queue
i_set_field(Uid,{skill_queue, Val}, R) ->
	R1 = R#m_unit_rw{skill_queue = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,skill_queue,R)),
	R1;
i_set_field(Uid,{skill_queue, Val, add}, R) ->
	R1 = R#m_unit_rw{skill_queue = R#m_unit_rw.skill_queue + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,skill_queue,R)),
	R1;
i_set_field(Uid,{skill_queue, Val, sub}, R) ->
	...
	?TRY_CATCH(hook_map:on_rw_update(Uid,skill_queue,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.skill_queue, Val}, R) ->
	R1 = R#m_unit_rw{skill_queue = Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,skill_queue,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.skill_queue, Val, add}, R) ->
	R1 = R#m_unit_rw{skill_queue = R#m_unit_rw.skill_queue + Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,skill_queue,R)),
	R1;
i_set_field(Uid,{#m_unit_rw.skill_queue, Val, sub}, R) ->
	R1 = R#m_unit_rw{skill_queue = R#m_unit_rw.skill_queue - Val},
	?TRY_CATCH(hook_map:on_rw_update(Uid,skill_queue,R)),
	R1;
