...
getRow(16095)->
    ...
    param8 = 0,
    param9 = 0,
    skillName = "钢铁狼-机甲冲撞：体验户口册造成对方主目标抗暴等级降低"
    };
getRow(16096)->
    #skill_effectCfg {
    iD = 16096,
