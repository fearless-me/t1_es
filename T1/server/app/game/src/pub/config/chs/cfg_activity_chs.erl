...
getRow(8)->
    ...
    lenghtime = 50400,
    stage = [{4,0}],
    mapidlist = [501,502,503,504,505,544],
    condition = 0,
    awardlist = [],
    limitApply = 2000,
    limitGroup = []
...
getRow(10)->
    ...
    starttime = [{5,20,15}],
    lenghtime = 2401,
    stage = [{0,1},{1,300},{1,300},{1,300},{4,600},{1,300},{4,600}],
    mapidlist = [4010],
    condition = 0,
    awardlist = [],
    limitApply = 2000,
...
getRow(16)->
    ...
    lenghtime = 1800,
    stage = [{0,1},{1,300},{1,300},{1,300},{4,900}],
    mapidlist = [9001],
    condition = 0,
    awardlist = [],
    limitApply = 2000,
...
getRow(22)->
    ...
    lenghtime = 2700,
    stage = [{0,1},{1,300},{1,300},{2,300},{4,1800}],
    mapidlist = [],
    condition = 0,
    awardlist = [],
    limitApply = 2000,
...
getRow(29)->
    ...
    lenghtime = 86400,
    stage = [],
    mapidlist = [50,51,52,53,54,55,56,57],
    condition = 0,
    awardlist = [],
    limitApply = 2000,
    groupApply = [],
