...
getRow(1)->
    ...
    time = "全天开放",
    num = 2,
    mapid = [{70,190},{88,191},{104,192},{118,193},{132,194},{144,195},{160,196},{180,197},{200,198}],
    npcid = 376,
    lookup_mapid = 0,
    coordinate = [],
    is_showvip = 0,
    ispvp = 0,
    mapid_team = [{70,190},{88,191},{104,192},{118,193},{132,194},{144,195},{160,196},{180,197},{200,198}]
    };
getRow(2)->
    #dailyInterfaceCfg {
    id = 2,
...
getRow(30)->
    ...
    time = "全天开放",
    num = 2,
    mapid = [{34,700},{45,701},{57,702},{67,703},{77,704},{87,705},{97,706},{107,707},{117,708},{127,709},{137,710},{147,711},{157,712},{167,713},{177,714},{187,715},{197,716},{207,717}],
    npcid = 0,
    lookup_mapid = 0,
    coordinate = [],
    is_showvip = 0,
...
getRow(31)->
    ...
    time = "全天开放",
    num = 2,
    mapid = [{40,528},{64,529},{80,530},{94,531},{110,532},{140,533},{160,534},{180,535},{200,536}],
    npcid = 0,
    lookup_mapid = 0,
    coordinate = [],
    is_showvip = 0,
    ispvp = 0,
    mapid_team = [{40,528},{64,529},{80,530},{94,531},{110,532},{140,533},{160,534},{180,535},{200,536}]
    };
getRow(32)->
    #dailyInterfaceCfg {
    id = 32,
...
getRow(35)->
    ...
    is_showvip = 0,
    ispvp = 0,
    mapid_team = [{30,540},{30,541},{30,542},{30,543}]
    };
getRow(36)->
    #dailyInterfaceCfg {
    id = 36,
...
getRow(37)->
    ...
    time = "全天开放",
    num = 2,
    mapid = [{24,1500},{40,1501},{58,1502},{76,1503},{96,1504},{116,1505},{136,1506},{156,1507},{176,1508},{196,1509},{216,1510},{236,1511}],
    npcid = 0,
    lookup_mapid = 0,
    coordinate = [],
    is_showvip = 0,
    ispvp = 0,
    mapid_team = [{24,1500},{40,1501},{58,1502},{76,1503},{96,1504},{116,1505},{136,1506},{156,1507},{176,1508},{196,1509},{216,1510},{236,1511}]
    };
getRow(38)->
    #dailyInterfaceCfg {
    id = 38,
...
getRow(39)->
    ...
    button = "前往挑战",
    team = [],
    txt = "[a6a6a6]\"僵尸部队大举入侵阿克勒，保卫我们的家园把\"[-]",
    time = "全天开放",
    num = 0,
    mapid = [{100,2003},{150,2004},{180,2005}],
    npcid = 0,
    lookup_mapid = 0,
    coordinate = [],
    is_showvip = 0,
...
getRow(2002)->
    ...
    button = "前往",
    team = [],
    txt = "[a6a6a6]前往幽界采集核心水晶。[-][ff6a00]所有采集将获得双倍收益！！[-]",
    time = "16:30~17:00",
    num = 0,
    mapid = [{-1,0}],
    npcid = 417,
