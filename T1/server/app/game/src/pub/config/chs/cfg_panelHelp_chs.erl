...
getRow(allpeopleanswerpanel)->
    #panelHelpCfg {
    id = allpeopleanswerpanel,
    help = "quanmingdati",
    tesk = "全民答题"
    };
getRow(applyguildpanel)->
    #panelHelpCfg {
    id = applyguildpanel,
    help = "jiazu",
    tesk = "家族"
...
getRow(battleroyaleenterpanel)->
    #panelHelpCfg {
    id = battleroyaleenterpanel,
    help = "jidiqiusheng",
    tesk = "极地求生"
    };
...
getRow(guildshoppanel)->
    #panelHelpCfg {
    id = guildshoppanel,
    help = "jiazushangdian",
    tesk = "家族商店"
    };
getRow(homeinfopanel)->
    #panelHelpCfg {
    id = homeinfopanel,
    help = "home",
    tesk = "家园"
...
getRow(myguildmemberpanel)->
    #panelHelpCfg {
    id = myguildmemberpanel,
    help = "jiazuqiyuan",
    tesk = "家族祈愿"
    };
getRow(myguildpanel)->
...
getRow(runeintensifypanel)->
    #panelHelpCfg {
    id = runeintensifypanel,
    help = "shengwufuc",
    tesk = "圣物功能"
    };
getRow(runepanel)->
...
getKeyList()->[
    ...
    {allpeopleanswerpanel},
    {applyguildpanel},
    {arenapanel},
    {bagpanel},
    {battleroyaleenterpanel},
    {bravetrialspanel},
    {bussypanel},
    {characterattribute},
    {checkinpanel},
