...
on_rw_update(?UID_TYPE_PLAYER, Uid, #m_object_rw.cur_pos, CurPos) ->
    gs_cache_interface:update_player_online(Uid, {#m_cache_player_online.pos, CurPos});
on_rw_update(?UID_TYPE_PLAYER, Uid, #m_object_rw.hp, Hp) ->
    gs_cache_interface:update_player_online(Uid, {#m_cache_player_online.hp, Hp});
on_rw_update(?UID_TYPE_PLAYER, Uid, #m_object_rw.buff_list, BuffList) ->
    gs_cache_interface:update_player_online(Uid, {#m_cache_player_online.buff_list, BuffList});
on_rw_update(?UID_TYPE_PLAYER, Uid, #m_object_rw.battle_props, BattleProps) ->
    gs_cache_interface:update_player_online(Uid, {#m_cache_player_online.battle_props, BattleProps});
on_rw_update(?UID_TYPE_PLAYER, Uid, #m_object_rw.state, State) ->
    gs_cache_interface:update_player_online(Uid, {#m_cache_player_online.state, State});
