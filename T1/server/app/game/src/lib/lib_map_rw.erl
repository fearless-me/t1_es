...
%%%-------------------------------------------------------------------
get_player(PlayerId) ->
    case ets:lookup(get_player_ets(), PlayerId) of
        [#r_obj{} = Obj | _] -> Obj;
        _ -> undefined
    end.
...
%%%-------------------------------------------------------------------
get_obj_pos(Obj) -> Obj#r_obj.pos.
get_obj_move_state(Obj) -> Obj#r_obj.cur_move.
get_obj_start_pos(Obj) -> Obj#r_obj.start.
get_obj_dest_pos(Obj) -> Obj#r_obj.dest.
get_obj_move_dir(Obj) -> Obj#r_obj.dir.
get_obj_face_to(Obj) -> Obj#r_obj.face.
get_obj_move_time(Obj) -> Obj#r_obj.last_up_time - Obj#r_obj.start_time.
get_obj_vis_tile_index(Obj) -> Obj#r_obj.vis_tile_idx.
set_obj_vis_tile_index(Obj, Index) -> Obj#r_obj{vis_tile_idx = Index}.
