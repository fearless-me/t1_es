...
-export([get_aid/0, get_aid_def/1, set_aid/1, set_aid_direct/1]).
-export([get_uid/0, get_uid_def/1, set_uid/1, set_uid_direct/1]).
-export([get_sid/0, get_sid_def/1, set_sid/1, set_sid_direct/1]).
-export([get_name/0, get_name_def/1, set_name/1, set_name_direct/1]).
-export([get_level/0, get_level_def/1, set_level/1, set_level_direct/1]).
-export([get_sex/0, get_sex_def/1, set_sex/1, set_sex_direct/1]).
-export([get_head/0, get_head_def/1, set_head/1, set_head_direct/1]).
-export([get_race/0, get_race_def/1, set_race/1, set_race_direct/1]).
-export([get_career/0, get_career_def/1, set_career/1, set_career_direct/1]).
-export([get_map/0, get_map_def/1, set_map/1, set_map_direct/1]).
-export([get_last_second_tick/0, get_last_second_tick_def/1, set_last_second_tick/1, set_last_second_tick_direct/1]).
-export([get_last_minute_tick/0, get_last_minute_tick_def/1, set_last_minute_tick/1, set_last_minute_tick_direct/1]).
-export([get_last_hour_tick/0, get_last_hour_tick_def/1, set_last_hour_tick/1, set_last_hour_tick_direct/1]).
-export([get_status/0, get_status_def/1, set_status/1, set_status_direct/1]).
-export([del/0]).
-export([to_record/0]).
-export([init_from/1]).
%%-------------------------------------------------------------------
