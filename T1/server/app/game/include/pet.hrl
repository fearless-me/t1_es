...
-define(DoublePetGuest, 1).
-define(DoublePetOwner, 2).

-define(PetState_Idle, 0).   %%宠物休息
-define(PetState_Assist, 1).   %%宠物助战
-define(PetState_Battle_Show, 2).   %%宠物出战-显示
-define(PetState_Battle_Hide, 3).   %%宠物出战-隐藏
-define(PetState_Battle_Mount, 4).   %%宠物出战-骑乘 (这个是服务器专用，用于登录时自动上坐骑)
...
-define(PetQualityWhite, 0).   %%白色品质宠物 -> 对应配置白色
-define(PetQualityGreen, 1).   %%绿色品质宠物 -> 对应配置绿色
-define(PetQualityBlue, 2).   %%蓝色品质宠物 -> 对应配置蓝色
-define(PetQualityPurple, 3).   %%紫色品质宠物 -> 对应配置红色
-define(PetQualityOrange, 4).   %%橙色品质宠物  -> 对应配置紫色
-define(PetQualityRed, 5).      %%红色品质宠物  -> 对应配置橙色
...
-define(PetSkillLocked, 0).   %%技能未解锁
-define(PetSkillUnLock, 1).   %%技能解锁
