...
-define(ItemSourceGuildWar, 	62).%%家族精英联赛获得
...
-define(ItemSourceLifeSkill, 	108).%%生活技能
-define(ItemSourceLoopTask, 	109).%%环/每日/家族任务-额外道具奖励
-define(ItemSourceDialBox, 	110).%%大转盘获得
-define(ItemSourceEquipResolve, 	111).%%装备分解
-define(ItemSourceCrossAliveSettle, 	112).%%跨服活动-大逃杀-结算奖励
-define(ItemSourceCrossAliveRank, 	113).%%跨服活动-大逃杀-排行榜奖励
-define(ItemSourceHomeFurniTrue, 	114).%%家园系统-家具系统-收获
-define(ItemSourceGuildLoopTask_Get, 	115).%%家族任务相关-索取道具获得
-define(ItemSourceGuildLoopTask_GiveBack, 	116).%%家族任务相关-捐赠失败道具返还
-define(ItemSourceGuildLoopTask_GiveReward, 	117).%%家族任务相关-捐赠道具奖励
-define(ItemSourceFloating_GiveReward, 	118).%%漂浮之石奖励来源
-define(ItemSourceCollectionWords_GiveReward, 	119).%%集字活动奖励来源
-define(ItemSourceGroupBuyGoodsBuy, 	120).%%团购活动购买获得
-define(ItemSourceGroupBuyRewardBuy, 	121).%%团购活动积分兑换获得
-define(ItemSourceEveryBuyVIP, 	122).%%每次购买特权卡获得的道具奖励
-define(ItemSourceMarriageReward, 	123).%%结婚奖励
-define(ItemSourceNvasionReward, 	124).%%暗夜侵袭奖励
-define(ItemSourceRoleAwakeReset, 	125).%%觉醒重置
-define(ItemSourceWedding, 	126).%%婚礼获得
-define(ItemSourceChangeNameFailed, 	127).%%使用道具改名失败补偿
-define(ItemSourceArunaWorldWar, 	128).%%Aruna世界大战道具奖励
-define(ItemSourceCareerPassiveSkillReset, 	129).%%转职被动技能重置获得
-define(ItemSourceMailCoinToItem, 	130).%%邮件获取金币时超过一亿就转换为物品
-define(ItemSourceKoreanaverRewardGet, 	131).%%韩国naver论坛独立需求活动 领奖获得
-define(ItemSourceHomeBossRewardGet, 	132).%%家园BOSS 奖励
-define(ItemSourceDeadLineGiftBuy, 	133).%%直购礼包(限时礼包) 购买
-define(ItemSourceNewFashionBuy, 	134).%%时装新品折扣活动购买
-define(ItemSourceNewFashionBeGiven, 	135).%%时装新品折扣活动被赠送
-define(ItemSourceFestivalGift, 	136).%%节日活动副本掉落
-define(ItemSourceFestivalGift2, 	137).%%节日活动时某些玩法额外掉落
-define(ItemSourceExchangeEquip, 	138).%%装备合成获得，与原有资源兑换15区分开
-define(ItemSourceWarriorTrialOneyKey, 	139).%%勇士试炼一键获得奖励
-define(ItemSourceQuestionnaireSurvey, 	140).%%问卷调查获得
-define(ItemSourceGMSimulateRecharge, 	141).%%GM模拟充值获得
...
-define(ItemDeleteReasonLifeSkill, 	552).%%生活技能消耗
-define(ItemDeleteReasonTaskHandIn, 	553).%%上交物品任务消耗
-define(ItemDeleteReasonEquipWash, 	554).%%装备洗练
-define(ItemDeleteReasonGuildLoopTask_Give, 	555).%%家族任务相关-捐赠道具消耗
-define(ItemDeleteReasonCollectionWords, 	556).%%集字活动物品消耗
-define(ItemDeleteReasonRideNoTimes, 	557).%%游乐道具使用次数消耗完毕
-define(ItemDeleteReasonNvasion, 	558).%%暗夜侵袭消耗
-define(ItemDeleteReasonRoleAwake, 	559).%%角色觉醒激活消耗
-define(ItemDeleteChangeName, 	560).%%使用道具改名
-define(ItemDeletePassiveSkillUp, 	561).%%被动技能升级消耗
-define(ItemDeleteWedding, 	562).%%婚礼道具消耗
-define(ItemDeleteFestivalCopy, 	563).%%节日活动消耗
-define(ItemDeleteLoopTaskOneKey, 	564).%%家族/环任务一键完成消耗
...
-define(CoinSourceLifeSkill, 	1046).%%生活技能
-define(CoinSourceLoopTask, 	1047).%%环/每日/家族任务-额外货币奖励
-define(CoinSourceGuildLoopTask_GiveReward, 	1048).%%家族任务相关-捐赠货币奖励
-define(CoinSourceGroupBuyBack, 	1049).%%团购结束返还折扣钻石（解冻钻石）
-define(CoinSourceBusinessSupperGift, 	1050).%%假装是商业化内容的签到奖励
-define(CoinSourceArunaWorldWar, 	1051).%%Aruna世界大战货币奖励
-define(CoinSourceBindDiamondCostDiamond, 	1052).%%绑钻产出：绑钻不足时自动消耗非绑钻兑换绑钻
-define(CoinSourceAssist, 	1053).%%助战 好人卡奖励
-define(CoinSourceRuneGold, 	1054).%%圣物出售
-define(CoinSourceHomeBoss, 	1055).%%家园BOSS
-define(CoinSourceWeddingRed, 	1056).%%婚礼红包
-define(CoinSourceBusinessCashDailyGift, 	1057).%%商业化内容现金礼包签到奖励
-define(CoinSourceBusinessGiveGold, 	1058).%%商业化内容额外赠送的钻石
-define(CoinSourceGMSimulateRecharge1, 	1059).%%GM模拟充值额外触发商业化内容额外赠送的钻石
-define(CoinSourceGMSimulateRecharge2, 	1060).%%GM模拟充值额外触发运营兑换活动兑换获得
-define(CoinSourceGMSimulateRecharge3, 	1061).%%GM模拟充值玩家充值
...
-define(CoinUseLoopTask_Refresh, 	10059).%%环/每日/家族任务-刷新任务货币消耗
...
-define(CoinUseLifeSkill, 	10080).%%生活技能消耗
-define(CoinUseDialBox, 	10081).%%大转盘消耗
-define(CoinUseSpirit, 	10082).%%精力
-define(CoinUseReasonGroupBuy, 	10083).%%团购活动购买团购商品消耗（冻结钻石）
-define(CoinUseReasonGroupBuyReal, 	10084).%%团购活动购买团购商品消耗（真正扣除钻石，便于审计）
-define(CoinUseReasonBuyBuff, 	10085).%%购买BUFF
-define(CoinUseReasonGatherBattleBuyTime, 	10086).%%购买跨服资源争夺时间
-define(CoinUseRoleAwakeExpToVigor, 	10087).%%角色觉醒兑换元气值消耗
-define(CoinUseRoleAwakeReset, 	10088).%%角色觉醒重置激活
-define(CoinUseReasonWedding, 	10089).%%婚礼消耗
-define(CoinUseMarriageTitleText, 	10090).%%修改婚姻称号
-define(CoinUsePassivaSkillUp, 	10091).%%被动技能升级消耗
-define(CoinUseBindDiamondCostDiamond, 	10092).%%非绑钻消耗：绑钻不足时自动消耗非绑钻兑换绑钻
-define(CoinUseDeadLineGiftBuy, 	10093).%%直购礼包(限时礼包) 购买消耗
-define(CoinUseFestivalGift, 	10094).%%节日活动购买礼包消耗
-define(CoinUseBuyChallengeCopyReward, 	10095).%%购买挑战本多倍奖励消耗
...
-define(ExpSourceLoopTask, 	20).%%环/每日/家族任务-额外经验奖励

%%玩家经验去向
-define(ExpOutTalentLevelUp, 	1).%%天赋升级使用
-define(ExpOutRoleToAwake, 	2).%%角色觉醒兑换元气值
-define(ExpOutCareerPassSkill, 	3).%%转职被动技能升级消耗
...
-define(TitleSourceMarriage, 	5).%%结婚奖励
-define(TitleSourceMarriageTitle, 	6).%%婚姻称号道具
