...
start_link(Ref, Socket, Transport, Opts) ->
    {ok, proc_lib:spawn_link(gen_serverw, init_loop, [?MODULE, {Ref, Socket, Transport, Opts}])}.
...
%%%% @end
%%%%--------------------------------------------------------------------
%%handle_call(Request, From, State) ->   gen_serverw:handle_call(Request, From, State).
%%    try
...
%%%% @end
%%%%--------------------------------------------------------------------
%%handle_cast(Request, State) -> gen_serverw:handle_cast(Request, State).
%%    try
...
%%%% @end
%%%%--------------------------------------------------------------------
%%handle_info(Info, State) -> gen_serverw:handle_info(Info, State).
%%
%%    try
