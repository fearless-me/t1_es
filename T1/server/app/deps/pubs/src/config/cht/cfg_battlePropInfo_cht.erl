...
getRow(146)->
    ...
    sequence = 13,
    propclass = 0,
    minitips = "破甲会无视角色的防御属性，破甲等级越高则技能破甲的几率越高",
    rolePanelShow = 0
    };
getRow(147)->
    #battlePropInfoCfg {
